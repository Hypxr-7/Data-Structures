...
void test_different_types() {
    ...
    try {
        QuicksortHoare<double>::sort(arr_double);
    ...
    try {
        QuicksortHoare<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running QuicksortHoare Tests ===" << std::endl;
    std::cout << std::endl;
