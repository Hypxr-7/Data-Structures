...
void test_empty_vector() {
    ...
    try {
        QuicksortBentleyMcIlroy<int>::sort(arr);
        assert(arr.empty());
...
void test_two_elements() {
    ...
    try {
        QuicksortBentleyMcIlroy<int>::sort(arr1);
    ...
    try {
        QuicksortBentleyMcIlroy<int>::sort(arr2);
...
void test_different_types() {
    ...
    try {
        QuicksortBentleyMcIlroy<double>::sort(arr_double);
    ...
    try {
        QuicksortBentleyMcIlroy<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running QuicksortBentleyMcIlroy Tests ===" << std::endl;
    std::cout << std::endl;
