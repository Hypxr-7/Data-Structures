...
void test_empty_vector() {
    ...
    try {
        InsertionSortOptimized<int>::sort(arr);
        assert(arr.empty());
...
void test_two_elements() {
    ...
    try {
        InsertionSortOptimized<int>::sort(arr1);
    ...
    try {
        InsertionSortOptimized<int>::sort(arr2);
...
void test_different_types() {
    ...
    try {
        InsertionSortOptimized<double>::sort(arr_double);
    ...
    try {
        InsertionSortOptimized<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running InsertionSortOptimized Tests ===" << std::endl;
    std::cout << std::endl;
