...
void test_constructor() {
    WeightedQuickUnionPathCompressionUF uf(5);
...
void test_single_element() {
    WeightedQuickUnionPathCompressionUF uf(1);
...
void test_multiple_unions() {
    WeightedQuickUnionPathCompressionUF uf(6);
...
void test_redundant_unions() {
    WeightedQuickUnionPathCompressionUF uf(4);
...
void test_self_union() {
    WeightedQuickUnionPathCompressionUF uf(3);
...
void test_destructor_memory_management() {
    ...
    {
        WeightedQuickUnionPathCompressionUF uf(100);
        for (int i = 0; i < 50; ++i) {
            uf.unite(i, i + 50);
        }
...
int main() {
    std::cout << "Running WeightedQuickUnionPathCompressionUF tests...\n\n";
