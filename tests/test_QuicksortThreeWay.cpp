...
void test_empty_vector() {
    ...
    try {
        QuicksortThreeWay<int>::sort(arr);
        assert(arr.empty());
...
void test_two_elements() {
    ...
    try {
        QuicksortThreeWay<int>::sort(arr1);
    ...
    try {
        QuicksortThreeWay<int>::sort(arr2);
...
void test_different_types() {
    ...
    try {
        QuicksortThreeWay<double>::sort(arr_double);
    ...
    try {
        QuicksortThreeWay<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running QuicksortThreeWay Tests ===" << std::endl;
    std::cout << std::endl;
