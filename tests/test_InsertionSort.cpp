...
void test_different_types() {
    ...
    try {
        InsertionSort<double>::sort(arr_double);
    ...
    try {
        InsertionSort<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running InsertionSort Tests ===" << std::endl;
    std::cout << std::endl;
