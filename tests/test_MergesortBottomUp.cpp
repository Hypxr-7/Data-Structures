...
void test_empty_vector() {
    ...
    try {
        MergesortBottomUp<int>::sort(arr);
        assert(arr.empty());
...
void test_two_elements() {
    ...
    try {
        MergesortBottomUp<int>::sort(arr1);
    ...
    try {
        MergesortBottomUp<int>::sort(arr2);
...
void test_different_types() {
    ...
    try {
        MergesortBottomUp<double>::sort(arr_double);
    ...
    try {
        MergesortBottomUp<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running MergesortBottomUp Tests ===" << std::endl;
    std::cout << std::endl;
