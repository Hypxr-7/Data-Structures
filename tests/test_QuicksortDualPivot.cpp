...
void test_empty_vector() {
    ...
    try {
        QuicksortDualPivot<int>::sort(arr);
        assert(arr.empty());
...
void test_two_elements() {
    ...
    try {
        QuicksortDualPivot<int>::sort(arr1);
    ...
    try {
        QuicksortDualPivot<int>::sort(arr2);
...
void test_different_types() {
    ...
    try {
        QuicksortDualPivot<double>::sort(arr_double);
    ...
    try {
        QuicksortDualPivot<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running QuicksortDualPivot Tests ===" << std::endl;
    std::cout << std::endl;
