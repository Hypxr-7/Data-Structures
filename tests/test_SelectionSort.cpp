...
void test_different_types() {
    ...
    try {
        SelectionSort<double>::sort(arr_double);
    ...
    try {
        SelectionSort<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running SelectionSort Tests ===" << std::endl;
    std::cout << std::endl;
