...
void test_empty_vector() {
    ...
    try {
        InsertionSortBinary<int>::sort(arr);
        assert(arr.empty());
...
void test_two_elements() {
    ...
    try {
        InsertionSortBinary<int>::sort(arr1);
    ...
    try {
        InsertionSortBinary<int>::sort(arr2);
...
void test_different_types() {
    ...
    try {
        InsertionSortBinary<double>::sort(arr_double);
    ...
    try {
        InsertionSortBinary<char>::sort(arr_char);
...
int main() {
    std::cout << "=== Running InsertionSortBinary Tests ===" << std::endl;
    std::cout << std::endl;
